...
Singh, Bharat, and Larry S. Davis. 2017. “An Analysis of Scale Invariance in Object Detection - SNIP.” arXiv [cs.CV]. arXiv. http://arxiv.org/abs/1711.08189.
...
Ha, David, and Jürgen Schmidhuber. 2018. “World Models.” arXiv [cs.LG]. arXiv. http://arxiv.org/abs/1803.10122.
    ...
    1. We collect 10K rollouts from a random policy (that is, what happened if we act randomly). As a result, we obtain 10K frame sequences.

    2. We train VAE on all the frames.

    3. We train MDN-RNN to model P(z_t) (probably using KL-loss).

    4. We train controller with CMA-ES method (evolution strategy) to maximize the expected cumulative reward.
